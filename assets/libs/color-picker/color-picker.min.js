...
((e, t, n) => {
    ...
    function p(e) {
        ...
        return [L(255 * t), L(255 * n), L(255 * r), w(e[3]) ? Number(e[3]) : 1];
    }
    function g(e) {
        let t,
            n,
        ...
        return [t, n, l, w(e[3]) ? Number(e[3]) : 1];
    }
    function v(e, t) {
    ...
    (e => {
        (e[i] = e => {
            ...
            return "#" + ("000000" + Y(Number(e[2]) | (Number(e[1]) << 8) | (Number(e[0]) << 16), 16)).slice(-6) + (w(e[3]) && e[3] < 1 ? Y(L(255 * e[3]) + 65536, 16).substr(-2) : "");
        }),
            (e.instances = {}),
        ...
        (e.CP = function (n, O) {
            ...
            !(function i(y, x) {
                ...
                function me() {
                    let e;
                    w((e = q)[1]) && H(Q, u, O - T / 2 - O * Number(e[1]) + l), w(e[2]) && H(Q, o, X - A / 2 - X * Number(e[2]) + l), w(e[0]) && H(U, o, fe - se / 2 - fe * Number(e[0]) + l), w(e[3]) && H(Z, o, ae - de / 2 - ae * Number(e[3]) + l);
                    let t = p(q),
                        n = p([q[0], 1, 1]);
